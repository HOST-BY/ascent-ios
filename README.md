...
Version 0.9.4 adds a Someday panel in My Day, explicit undated task creation and one-click scheduling for today. Undated tasks stay separate from the daily plan. Existing task records remain compatible.
